...
if(typeof jvxObjectList == "undefined"){
	var jvxObjectList = ["jvx_611eb296c0ed7"];
}else{
	jvxObjectList.push("jvx_611eb296c0ed7");
}
    ...
    try{
        ...
        if(cScrNode == undefined){
            ...
            for(var i=0;i<scrNodes.length;i++){
                ...
                if(scrSrc &&  scrSrc.indexOf("https://as.jivox.com/unit/unit_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=45f3d18e47f96c&campaignId=145089&es_pId=lP6W4c&isDynamic=1&ap_DataSignal1=42577385&ap_DataSignal2=ABAjH0jeK3U7pE0BpPPlQUeL6Nph&ap_DataSignal3=327227621&ap_DataSignal4=851838508933&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https://googleads.g.doubleclick.net/dbm/clk%3Fsa%3DL%26ai%3DCG60XNLIeYczJIMeb1waBz4-YDKfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLLJyNzl52zPqgDAaoE8wFP0Fr4MFm6iaLiUFxJPR9qV7vSZ2AFbGDbG3-g1jEgy7HxvMuPfOC5coezWwxbX2AnrP5rTc1uMOFarM9fANLJbwMGqa7hDzuo8rhMaONHY6o4HRw7zyReUn6Rjx8Nt1Qo1ZqQaJS0dZcoPnkh8MVmjvapNCsUKeSvr_5qdDYgT3OwgYFVUvCGveJsZm5Ge-JZcY-WGmrRJkBO11DSY2-5QC2gTCbZIphDKFO7m5RbOUuC5Sn4IXG5kLI7UMErHTtn6o2WppV20c_6ZS7PYX2j6yHNv2CZIcJsOlS7stCAQebwP7_kgjrdde0b6sOdk2tOBvzABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQGAFwE%26ae%3D1%26num%3D1%26cid%3DCAASEuRoLtSrTOQM43GThHuVQAZExw%26sig%3DAOD64_1qiDglALhxXGve7xshtlNIhhqPfg%26client%3Dca-pub-9222145312954144%26dbm_c%3DAKAmf-DmoPObucoI01AsKuhNAFCmBeciFSAD5ukZMMetU43hiiy1OC_S4rHih31zIazIavUDQ3l6H8x4T7JTEDE3jUedd6qEgKD7dzo0A_RJkYWyOR3wxeormlMdBteBSxhnHlrTkuYBM4tRlQdjHa6E5LMVS7LPYA%26dbm_d%3DAKAmf-CmbupBbXv96UrrCSSekC-euCgw0A2KR5WQ-nX1eCj7rmn82E4oeNuGaFf-24WdFijQEGu1LGCUm_TW5OaR6E67SAOMKowhbGZbVeySGGFP6EnNmgG9W6Q0nrheVSrwsAJoo_G6zZ2MbX6YObqTTz9qAbFNHmOUJP-MBq0gA3AX2GWACFAGUrpXzmsW-hj-GyywWz5DbjxAkJ29_t3qMcCPMgF34uyGS13EOkW2qd2ObAcGpTDflfbNDsDtAD2u4ycfMhz3jVsgm7fS9PBbew5VeC_Fxlf8k9loIPTelW3Gm_U-Lwu3eqhRCJBpL9Fk9cUuGjK33ScK8bGnuO_HaWlwwv-rDK5XlcJ0Un-P0LyKURp1ctGQrLZzsTBJ73tkoNF1EHFkElY6gAU9NkCcdsGBV-qWRCHWs2v-gnlyqBmdtd_yJkMF9BIxTG0LTgFLfMz1axpR9ka1hyBTzezsRzK8mEGixg%26adurl%3D&r=1629401652533708") != -1){
                    cScrNode = scrNodes[i];
                }
            }
        }   
...
function jvxCopyObject(target,obj){
	...
	if(document.body == null){
		document.write("<div id='jvxSkeletonRef_611eb296c0ed7' style='display:none;'></div>")
	}
/*
JavaScript responsible for frame busting
*/
var jvx_611eb296c0ed7TraffickedInFrame = false,			// COM: should be true, if !busted and self != top
	jvx_611eb296c0ed7SafeFrameSupported = false,		// COM: should be true only when safeFrame is supported in the page
	jvx_611eb296c0ed7CanBustFromFrame = true,			// COM: should be false, when all busting method fails
	jvx_611eb296c0ed7InNestedFrame = false;				// COM: should be true, when tag trafficked inside nested frame

if(self != top){
	jvx_611eb296c0ed7TraffickedInFrame = true;
}

try{
		$sf.ext.register(300, 250);
		jvx_611eb296c0ed7SafeFrameSupported = true;
}catch(e){
	jvx_611eb296c0ed7SafeFrameSupported = false;
}
...
var adViewabilityDetectInit = function (visibilityThreshold) { 
    try {
        ...
        boxElement = document.querySelector('#adUnitContainer_611eb296c0ed7');
                    ...
                    if (!adInVPForOneSec && !timerRunning) {
                        ...
                        timeoutHandle = setTimeout(function () {
                            adInVPForOneSec = true;
                                                        if(typeof jvx_611eb296c0ed7 != "undefined")
                            jvx_611eb296c0ed7.recordEvent(73);
                            else 
                            recordEvent(73);
                                                    }, 1000);
                    }
...
var CreativeUnit = (function(){
	...
	function receiveHtml5Message(e){
        ...
        var s = e.data.split(':', 10);
		        if(s && s.length >= 2 && s[0] == 'jvx_611eb296c0ed7'){
			var msg = s[1];
			if(msg == 'openExpansion'){
									jvx_611eb296c0ed7.openClickThrough();
							} else if(msg == 'closeExpansion'){
				jvx_611eb296c0ed7.closeExpansion(false, false);
			} else if(msg == 'expansionLoaded'){
							} else if(msg == 'recordUIR'){
				jvx_611eb296c0ed7.UIRRecorded = true;
			} else if(msg == 'lastMouseLeave'){
				jvx_611eb296c0ed7.lastMLeaveId = s[2];
			} else if(msg == 'clearUIR'){
				clearTimeout(jvx_611eb296c0ed7.UIRTimer);
			} else if(msg == 'recordDwell'){
				if(!jvx_611eb296c0ed7.DwellRecorded){
					jvx_611eb296c0ed7.recordDwellEvent(49, jvx_611eb296c0ed7.DwellElapsedTime);
				}
			}
									else if(msg=="dynamicProperties") {
                jvx_611eb296c0ed7.updateDYProperties(s[2],1);
							}
												                        else if(msg == "miniScrollerBgInfo"){
                var miniScrollerBgURL = decodeURIComponent(s[2]);
                jvx_611eb296c0ed7.fixedBgAstLeft = parseInt(s[3]);
                jvx_611eb296c0ed7.renderFixedPageBg(miniScrollerBgURL,s[3]);
            } 
		}
	}
	...
	function postHtml5Message(winRef, msg){
		try{
			winRef.postMessage('jvx_611eb296c0ed7' + ':' + msg, "*");
		}catch(e){
			if(typeof(winRef.contentWindow) != 'undefined')
				winRef.contentWindow.postMessage('jvx_611eb296c0ed7' + ':' + msg, "*");
		}
	}
	...
	*/
	...
	function clearNode(pNode, idPrefix){
        ...
        if(jvx_611eb296c0ed7TraffickedInFrame){
                        try{
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
			...
			if(url.indexOf("?") == -1){
				...
				finalURL = url + "&r=" + Math.random();
					...
					if(typeof jvx_611eb296c0ed7 != 'undefined'){
				finalURL += "&es_cgName_"+jvx_611eb296c0ed7.DYReportingKey;
                if(jvx_611eb296c0ed7.DYSegmentName != ""){
                    finalURL += "&es_segName_"+jvx_611eb296c0ed7.DYSegmentName;
                }
			}
				imgEl.src = finalURL;
			}       
	...
	function setOpacity(myElement, opacityValue) {
		...
		var cLeft = sfLeft + "px",
			cTop = sfTop + "px",
			cNode = getElById(jvx_611eb296c0ed7.adUnitContainerId);
		addStyles(cNode, {"left":cLeft, "top":cTop});
	}
	function renderAdInsideSafeFrame(animDir){
		if(jvx_611eb296c0ed7SafeFrameSupported){
			/* ------------- SafeFrame Settings--------------- */
						var ref = jvx_611eb296c0ed7,
	 ...
	 /* var rect = obj.getBoundingClientRect();
		...
		var vpStyles = findPos(getElById(jvx_611eb296c0ed7.adUnitContainerId)),
			vpTop = "", vpLeft = "";
	...
	function mraidHandleOnViewable(viewable){
		jvxMraidIsShown = viewable;		 
			if(!jvxMraidIsShown || getElById(jvx_611eb296c0ed7.baseContainerId)){
				return; 
			}
		jvx_611eb296c0ed7.init();
	...
	function handleMraidViewableImprFiring(){
		if (!adInVPForOneSec && !timerRunning) {
			...
			var timeoutHandle = setTimeout(function () {
				adInVPForOneSec = true;
				jvx_611eb296c0ed7.recordEvent(74);
			}, 1000);
		}
	}
	...
	function CreativeUnit(uniqId){
	    ...
	    this.id = uniqId;  
		this.playerParamsMap = {"reportingURL":"https:\/\/evs.jivox.com","addPostCode":"https:\/\/cdn.jivox.com\/files\/46220\/Nike_DV\/dv_nike.js","creativeUnitType":"20","bDim":"300x250","bUnitId":"2000","siteId":"45f3d18e47f96c","campaignId":"145089","es_pId":"lP6W4c","isDynamic":"1","ap_DataSignal1":"42577385","ap_DataSignal2":"ABAjH0jeK3U7pE0BpPPlQUeL6Nph","ap_DataSignal3":"327227621","ap_DataSignal4":"851838508933","gdpr":"","gdpr_consent":"","jvxVer":"2","cMacro":"https:\/\/googleads.g.doubleclick.net\/dbm\/clk?sa=L&ai=CG60XNLIeYczJIMeb1waBz4-YDKfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLLJyNzl52zPqgDAaoE8wFP0Fr4MFm6iaLiUFxJPR9qV7vSZ2AFbGDbG3-g1jEgy7HxvMuPfOC5coezWwxbX2AnrP5rTc1uMOFarM9fANLJbwMGqa7hDzuo8rhMaONHY6o4HRw7zyReUn6Rjx8Nt1Qo1ZqQaJS0dZcoPnkh8MVmjvapNCsUKeSvr_5qdDYgT3OwgYFVUvCGveJsZm5Ge-JZcY-WGmrRJkBO11DSY2-5QC2gTCbZIphDKFO7m5RbOUuC5Sn4IXG5kLI7UMErHTtn6o2WppV20c_6ZS7PYX2j6yHNv2CZIcJsOlS7stCAQebwP7_kgjrdde0b6sOdk2tOBvzABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQGAFwE&ae=1&num=1&cid=CAASEuRoLtSrTOQM43GThHuVQAZExw&sig=AOD64_1qiDglALhxXGve7xshtlNIhhqPfg&client=ca-pub-9222145312954144&dbm_c=AKAmf-DmoPObucoI01AsKuhNAFCmBeciFSAD5ukZMMetU43hiiy1OC_S4rHih31zIazIavUDQ3l6H8x4T7JTEDE3jUedd6qEgKD7dzo0A_RJkYWyOR3wxeormlMdBteBSxhnHlrTkuYBM4tRlQdjHa6E5LMVS7LPYA&dbm_d=AKAmf-CmbupBbXv96UrrCSSekC-euCgw0A2KR5WQ-nX1eCj7rmn82E4oeNuGaFf-24WdFijQEGu1LGCUm_TW5OaR6E67SAOMKowhbGZbVeySGGFP6EnNmgG9W6Q0nrheVSrwsAJoo_G6zZ2MbX6YObqTTz9qAbFNHmOUJP-MBq0gA3AX2GWACFAGUrpXzmsW-hj-GyywWz5DbjxAkJ29_t3qMcCPMgF34uyGS13EOkW2qd2ObAcGpTDflfbNDsDtAD2u4ycfMhz3jVsgm7fS9PBbew5VeC_Fxlf8k9loIPTelW3Gm_U-Lwu3eqhRCJBpL9Fk9cUuGjK33ScK8bGnuO_HaWlwwv-rDK5XlcJ0Un-P0LyKURp1ctGQrLZzsTBJ73tkoNF1EHFkElY6gAU9NkCcdsGBV-qWRCHWs2v-gnlyqBmdtd_yJkMF9BIxTG0LTgFLfMz1axpR9ka1hyBTzezsRzK8mEGixg&adurl=","r":"1629401652533708","removeClickParams":"1","serverURL":"https:\/\/as.jivox.com"};
		...
		this.asyncCompletedTaskCount = 0;
			...
			this.asyncTaskCount++;
                        ...
                        this.apParamsArr = {"ap_DataSignal1":"42577385","ap_DataSignal2":"ABAjH0jeK3U7pE0BpPPlQUeL6Nph","ap_DataSignal3":"327227621","ap_DataSignal4":"851838508933"};
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=45f3d18e47f96c&campaignId=145089&es_pId=lP6W4c&isDynamic=1&ap_DataSignal1=42577385&ap_DataSignal2=ABAjH0jeK3U7pE0BpPPlQUeL6Nph&ap_DataSignal3=327227621&ap_DataSignal4=851838508933&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCG60XNLIeYczJIMeb1waBz4-YDKfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLLJyNzl52zPqgDAaoE8wFP0Fr4MFm6iaLiUFxJPR9qV7vSZ2AFbGDbG3-g1jEgy7HxvMuPfOC5coezWwxbX2AnrP5rTc1uMOFarM9fANLJbwMGqa7hDzuo8rhMaONHY6o4HRw7zyReUn6Rjx8Nt1Qo1ZqQaJS0dZcoPnkh8MVmjvapNCsUKeSvr_5qdDYgT3OwgYFVUvCGveJsZm5Ge-JZcY-WGmrRJkBO11DSY2-5QC2gTCbZIphDKFO7m5RbOUuC5Sn4IXG5kLI7UMErHTtn6o2WppV20c_6ZS7PYX2j6yHNv2CZIcJsOlS7stCAQebwP7_kgjrdde0b6sOdk2tOBvzABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQGAFwE%26ae%3D1%26num%3D1%26cid%3DCAASEuRoLtSrTOQM43GThHuVQAZExw%26sig%3DAOD64_1qiDglALhxXGve7xshtlNIhhqPfg%26client%3Dca-pub-9222145312954144%26dbm_c%3DAKAmf-DmoPObucoI01AsKuhNAFCmBeciFSAD5ukZMMetU43hiiy1OC_S4rHih31zIazIavUDQ3l6H8x4T7JTEDE3jUedd6qEgKD7dzo0A_RJkYWyOR3wxeormlMdBteBSxhnHlrTkuYBM4tRlQdjHa6E5LMVS7LPYA%26dbm_d%3DAKAmf-CmbupBbXv96UrrCSSekC-euCgw0A2KR5WQ-nX1eCj7rmn82E4oeNuGaFf-24WdFijQEGu1LGCUm_TW5OaR6E67SAOMKowhbGZbVeySGGFP6EnNmgG9W6Q0nrheVSrwsAJoo_G6zZ2MbX6YObqTTz9qAbFNHmOUJP-MBq0gA3AX2GWACFAGUrpXzmsW-hj-GyywWz5DbjxAkJ29_t3qMcCPMgF34uyGS13EOkW2qd2ObAcGpTDflfbNDsDtAD2u4ycfMhz3jVsgm7fS9PBbew5VeC_Fxlf8k9loIPTelW3Gm_U-Lwu3eqhRCJBpL9Fk9cUuGjK33ScK8bGnuO_HaWlwwv-rDK5XlcJ0Un-P0LyKURp1ctGQrLZzsTBJ73tkoNF1EHFkElY6gAU9NkCcdsGBV-qWRCHWs2v-gnlyqBmdtd_yJkMF9BIxTG0LTgFLfMz1axpR9ka1hyBTzezsRzK8mEGixg%26adurl%3D&r=1629401652533708&objectName=jvx_611eb296c0ed7&adUnitId=2000&jvxSessionId=1629401750.8449';
        			this.baseURL += '&base=1';
	...
	CreativeUnit.prototype = {
		constructor:CreativeUnit,
         ...
         sendCookieRequest: function(cookieName){
	        if(jvx_611eb296c0ed7SafeFrameSupported){
		         var callBackFnName ='jvx_611eb296c0ed7'+".updateDYProperties";
		         jvx_611eb296c0ed7.addScriptTagToBody('https://as.jivox.com'+"/unit/getCookies.php?cookieName="+cookieName+"&callback="+callBackFnName+"&deleteCookie="+1+"&r_="+Math.random());  
	         }                  
         },
         updateDYProperties: function(val,isNotCookieData){
            ...
            jvx_611eb296c0ed7.DYReportingKey = dynPropArr[0] ? decodeURIComponent(dynPropArr[0]) : "";
            jvx_611eb296c0ed7.DYSegmentName = dynPropArr[1] ? decodeURIComponent(dynPropArr[1]) : "";
            //this.fireCREvent();
         },
			...
			if(doFireCreativeLoadEvt){
				...
				jvx_611eb296c0ed7.recordEvent(72, 'es_et=' + creativeLoadElapseTime);
			}
		},
                    ...
                    if(jvx_611eb296c0ed7SafeFrameSupported){
                        var getReportingKeyFromCookie = false,
                            ...
                            if(getReportingKeyFromCookie){
                                jvx_611eb296c0ed7.sendCookieRequest('jvx_611eb296c0ed7'+"_dynamicProperties");
                            }
                    }
                											}	
		},
			...
			var executeCallBack = function(transitionEvt){
					...
					if(ref.expansionOpen){
						...
						if(ref.openExpAgain) ref.openExpAgain = false; 
												...
												if(jvx_611eb296c0ed7SafeFrameSupported && transitionEvt){
							try{
								$sf.ext.collapse();
															}catch(e){}
						}
		...
		getIBusterFrameInfo:function(){
			if(typeof(jivoxIBusterAdObject) != "undefined"){
				...
				for(var i=0; i < iFramesLen; i++){
					if(hostIframes[i].contentWindow == jivoxIBusterAdObject["jvx_611eb296c0ed7"].foreignWindow){
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		openClickThrough:function(){
							this.openWindow('https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=CG60XNLIeYczJIMeb1waBz4-YDKfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLLJyNzl52zPqgDAaoE8wFP0Fr4MFm6iaLiUFxJPR9qV7vSZ2AFbGDbG3-g1jEgy7HxvMuPfOC5coezWwxbX2AnrP5rTc1uMOFarM9fANLJbwMGqa7hDzuo8rhMaONHY6o4HRw7zyReUn6Rjx8Nt1Qo1ZqQaJS0dZcoPnkh8MVmjvapNCsUKeSvr_5qdDYgT3OwgYFVUvCGveJsZm5Ge-JZcY-WGmrRJkBO11DSY2-5QC2gTCbZIphDKFO7m5RbOUuC5Sn4IXG5kLI7UMErHTtn6o2WppV20c_6ZS7PYX2j6yHNv2CZIcJsOlS7stCAQebwP7_kgjrdde0b6sOdk2tOBvzABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQGAFwE&ae=1&num=1&cid=CAASEuRoLtSrTOQM43GThHuVQAZExw&sig=AOD64_1qiDglALhxXGve7xshtlNIhhqPfg&client=ca-pub-9222145312954144&dbm_c=AKAmf-DmoPObucoI01AsKuhNAFCmBeciFSAD5ukZMMetU43hiiy1OC_S4rHih31zIazIavUDQ3l6H8x4T7JTEDE3jUedd6qEgKD7dzo0A_RJkYWyOR3wxeormlMdBteBSxhnHlrTkuYBM4tRlQdjHa6E5LMVS7LPYA&dbm_d=AKAmf-CmbupBbXv96UrrCSSekC-euCgw0A2KR5WQ-nX1eCj7rmn82E4oeNuGaFf-24WdFijQEGu1LGCUm_TW5OaR6E67SAOMKowhbGZbVeySGGFP6EnNmgG9W6Q0nrheVSrwsAJoo_G6zZ2MbX6YObqTTz9qAbFNHmOUJP-MBq0gA3AX2GWACFAGUrpXzmsW-hj-GyywWz5DbjxAkJ29_t3qMcCPMgF34uyGS13EOkW2qd2ObAcGpTDflfbNDsDtAD2u4ycfMhz3jVsgm7fS9PBbew5VeC_Fxlf8k9loIPTelW3Gm_U-Lwu3eqhRCJBpL9Fk9cUuGjK33ScK8bGnuO_HaWlwwv-rDK5XlcJ0Un-P0LyKURp1ctGQrLZzsTBJ73tkoNF1EHFkElY6gAU9NkCcdsGBV-qWRCHWs2v-gnlyqBmdtd_yJkMF9BIxTG0LTgFLfMz1axpR9ka1hyBTzezsRzK8mEGixg&adurl=http%3A%2F%2Fwww.nike.com');
				...
				openExpansion:function(autoExpand, skipOpenEvent){
						...
						if(!jvx_611eb296c0ed7CanBustFromFrame || jvx_611eb296c0ed7InNestedFrame){
				return;
			}
		...
		recordEvent:function(eventId,addnlParams){
				...
				var imgEl = document.createElement("img");
                var tempURL = "";
                var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + "145089/45f3d18e47f96c/20/jvxSId_1629401750.8449";
				...
				//eventReportingURL = (eventId == 1) ? (eventReportingURL + ";https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=CG60XNLIeYczJIMeb1waBz4-YDKfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLLJyNzl52zPqgDAaoE8wFP0Fr4MFm6iaLiUFxJPR9qV7vSZ2AFbGDbG3-g1jEgy7HxvMuPfOC5coezWwxbX2AnrP5rTc1uMOFarM9fANLJbwMGqa7hDzuo8rhMaONHY6o4HRw7zyReUn6Rjx8Nt1Qo1ZqQaJS0dZcoPnkh8MVmjvapNCsUKeSvr_5qdDYgT3OwgYFVUvCGveJsZm5Ge-JZcY-WGmrRJkBO11DSY2-5QC2gTCbZIphDKFO7m5RbOUuC5Sn4IXG5kLI7UMErHTtn6o2WppV20c_6ZS7PYX2j6yHNv2CZIcJsOlS7stCAQebwP7_kgjrdde0b6sOdk2tOBvzABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQGAFwE&ae=1&num=1&cid=CAASEuRoLtSrTOQM43GThHuVQAZExw&sig=AOD64_1qiDglALhxXGve7xshtlNIhhqPfg&client=ca-pub-9222145312954144&dbm_c=AKAmf-DmoPObucoI01AsKuhNAFCmBeciFSAD5ukZMMetU43hiiy1OC_S4rHih31zIazIavUDQ3l6H8x4T7JTEDE3jUedd6qEgKD7dzo0A_RJkYWyOR3wxeormlMdBteBSxhnHlrTkuYBM4tRlQdjHa6E5LMVS7LPYA&dbm_d=AKAmf-CmbupBbXv96UrrCSSekC-euCgw0A2KR5WQ-nX1eCj7rmn82E4oeNuGaFf-24WdFijQEGu1LGCUm_TW5OaR6E67SAOMKowhbGZbVeySGGFP6EnNmgG9W6Q0nrheVSrwsAJoo_G6zZ2MbX6YObqTTz9qAbFNHmOUJP-MBq0gA3AX2GWACFAGUrpXzmsW-hj-GyywWz5DbjxAkJ29_t3qMcCPMgF34uyGS13EOkW2qd2ObAcGpTDflfbNDsDtAD2u4ycfMhz3jVsgm7fS9PBbew5VeC_Fxlf8k9loIPTelW3Gm_U-Lwu3eqhRCJBpL9Fk9cUuGjK33ScK8bGnuO_HaWlwwv-rDK5XlcJ0Un-P0LyKURp1ctGQrLZzsTBJ73tkoNF1EHFkElY6gAU9NkCcdsGBV-qWRCHWs2v-gnlyqBmdtd_yJkMF9BIxTG0LTgFLfMz1axpR9ka1hyBTzezsRzK8mEGixg&adurl=http%3A%2F%2Fwww.nike.com") : eventReportingURL;
									tempURL += "/es_cgName="+jvx_611eb296c0ed7.DYReportingKey;
                    if(jvx_611eb296c0ed7.DYSegmentName != ""){
                        tempURL += "/es_segName="+jvx_611eb296c0ed7.DYSegmentName;
                    }
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			this.DwellTimer = null;
						...
						var cNode = createDivNode(this.adUnitContainerId);
			            												document.write('<div id="jvxScrRefNode_611eb296c0ed7" style="display:none;"></div>');	
				var jvxPNode = '';
				var jvxNode = getElById("jvxScrRefNode_611eb296c0ed7");
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=45f3d18e47f96c&campaignId=145089&es_pId=lP6W4c&isDynamic=1&ap_DataSignal1=42577385&ap_DataSignal2=ABAjH0jeK3U7pE0BpPPlQUeL6Nph&ap_DataSignal3=327227621&ap_DataSignal4=851838508933&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCG60XNLIeYczJIMeb1waBz4-YDKfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLLJyNzl52zPqgDAaoE8wFP0Fr4MFm6iaLiUFxJPR9qV7vSZ2AFbGDbG3-g1jEgy7HxvMuPfOC5coezWwxbX2AnrP5rTc1uMOFarM9fANLJbwMGqa7hDzuo8rhMaONHY6o4HRw7zyReUn6Rjx8Nt1Qo1ZqQaJS0dZcoPnkh8MVmjvapNCsUKeSvr_5qdDYgT3OwgYFVUvCGveJsZm5Ge-JZcY-WGmrRJkBO11DSY2-5QC2gTCbZIphDKFO7m5RbOUuC5Sn4IXG5kLI7UMErHTtn6o2WppV20c_6ZS7PYX2j6yHNv2CZIcJsOlS7stCAQebwP7_kgjrdde0b6sOdk2tOBvzABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQGAFwE%26ae%3D1%26num%3D1%26cid%3DCAASEuRoLtSrTOQM43GThHuVQAZExw%26sig%3DAOD64_1qiDglALhxXGve7xshtlNIhhqPfg%26client%3Dca-pub-9222145312954144%26dbm_c%3DAKAmf-DmoPObucoI01AsKuhNAFCmBeciFSAD5ukZMMetU43hiiy1OC_S4rHih31zIazIavUDQ3l6H8x4T7JTEDE3jUedd6qEgKD7dzo0A_RJkYWyOR3wxeormlMdBteBSxhnHlrTkuYBM4tRlQdjHa6E5LMVS7LPYA%26dbm_d%3DAKAmf-CmbupBbXv96UrrCSSekC-euCgw0A2KR5WQ-nX1eCj7rmn82E4oeNuGaFf-24WdFijQEGu1LGCUm_TW5OaR6E67SAOMKowhbGZbVeySGGFP6EnNmgG9W6Q0nrheVSrwsAJoo_G6zZ2MbX6YObqTTz9qAbFNHmOUJP-MBq0gA3AX2GWACFAGUrpXzmsW-hj-GyywWz5DbjxAkJ29_t3qMcCPMgF34uyGS13EOkW2qd2ObAcGpTDflfbNDsDtAD2u4ycfMhz3jVsgm7fS9PBbew5VeC_Fxlf8k9loIPTelW3Gm_U-Lwu3eqhRCJBpL9Fk9cUuGjK33ScK8bGnuO_HaWlwwv-rDK5XlcJ0Un-P0LyKURp1ctGQrLZzsTBJ73tkoNF1EHFkElY6gAU9NkCcdsGBV-qWRCHWs2v-gnlyqBmdtd_yJkMF9BIxTG0LTgFLfMz1axpR9ka1hyBTzezsRzK8mEGixg%26adurl%3D&r=1629401652533708&objectName=jvx_611eb296c0ed7';
											this.baseURL += '&jvxSessionId=1629401750.8449';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&&siteId=45f3d18e47f96c&campaignId=145089&es_pId=lP6W4c&isDynamic=1&ap_DataSignal1=42577385&ap_DataSignal2=ABAjH0jeK3U7pE0BpPPlQUeL6Nph&ap_DataSignal3=327227621&ap_DataSignal4=851838508933&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCG60XNLIeYczJIMeb1waBz4-YDKfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLLJyNzl52zPqgDAaoE8wFP0Fr4MFm6iaLiUFxJPR9qV7vSZ2AFbGDbG3-g1jEgy7HxvMuPfOC5coezWwxbX2AnrP5rTc1uMOFarM9fANLJbwMGqa7hDzuo8rhMaONHY6o4HRw7zyReUn6Rjx8Nt1Qo1ZqQaJS0dZcoPnkh8MVmjvapNCsUKeSvr_5qdDYgT3OwgYFVUvCGveJsZm5Ge-JZcY-WGmrRJkBO11DSY2-5QC2gTCbZIphDKFO7m5RbOUuC5Sn4IXG5kLI7UMErHTtn6o2WppV20c_6ZS7PYX2j6yHNv2CZIcJsOlS7stCAQebwP7_kgjrdde0b6sOdk2tOBvzABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQGAFwE%26ae%3D1%26num%3D1%26cid%3DCAASEuRoLtSrTOQM43GThHuVQAZExw%26sig%3DAOD64_1qiDglALhxXGve7xshtlNIhhqPfg%26client%3Dca-pub-9222145312954144%26dbm_c%3DAKAmf-DmoPObucoI01AsKuhNAFCmBeciFSAD5ukZMMetU43hiiy1OC_S4rHih31zIazIavUDQ3l6H8x4T7JTEDE3jUedd6qEgKD7dzo0A_RJkYWyOR3wxeormlMdBteBSxhnHlrTkuYBM4tRlQdjHa6E5LMVS7LPYA%26dbm_d%3DAKAmf-CmbupBbXv96UrrCSSekC-euCgw0A2KR5WQ-nX1eCj7rmn82E4oeNuGaFf-24WdFijQEGu1LGCUm_TW5OaR6E67SAOMKowhbGZbVeySGGFP6EnNmgG9W6Q0nrheVSrwsAJoo_G6zZ2MbX6YObqTTz9qAbFNHmOUJP-MBq0gA3AX2GWACFAGUrpXzmsW-hj-GyywWz5DbjxAkJ29_t3qMcCPMgF34uyGS13EOkW2qd2ObAcGpTDflfbNDsDtAD2u4ycfMhz3jVsgm7fS9PBbew5VeC_Fxlf8k9loIPTelW3Gm_U-Lwu3eqhRCJBpL9Fk9cUuGjK33ScK8bGnuO_HaWlwwv-rDK5XlcJ0Un-P0LyKURp1ctGQrLZzsTBJ73tkoNF1EHFkElY6gAU9NkCcdsGBV-qWRCHWs2v-gnlyqBmdtd_yJkMF9BIxTG0LTgFLfMz1axpR9ka1hyBTzezsRzK8mEGixg%26adurl%3D&r=1629401652533708&objectName=jvx_611eb296c0ed7'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1629401750.8449';
		...
		listenerCallback:function(event) {
			jvx_611eb296c0ed7.eventController(event); 
		},
...
var jvx_611eb296c0ed7 = new CreativeUnit("_611eb296c0ed7");
jvx_611eb296c0ed7.DYReportingKey = "";
jvx_611eb296c0ed7.DYSegmentName = "";
	if(NonMraidTagInMraidEnv){
				jvx_611eb296c0ed7.recordEvent(75);
	}
    jvx_611eb296c0ed7.init();
