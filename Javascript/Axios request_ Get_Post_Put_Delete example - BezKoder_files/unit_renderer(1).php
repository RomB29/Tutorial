...
if(typeof jvxObjectList == "undefined"){
	var jvxObjectList = ["jvx_611eb297e849e"];
}else{
	jvxObjectList.push("jvx_611eb297e849e");
}
    ...
    try{
        ...
        if(cScrNode == undefined){
            ...
            for(var i=0;i<scrNodes.length;i++){
                ...
                if(scrSrc &&  scrSrc.indexOf("https://as.jivox.com/unit/unit_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=45f3d18e47f96c&campaignId=145089&es_pId=lP6W4c&isDynamic=1&ap_DataSignal1=42577385&ap_DataSignal2=ABAjH0ibgypJGjbarXO0QYnWzfg1&ap_DataSignal3=327227621&ap_DataSignal4=851838508933&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https://googleads.g.doubleclick.net/dbm/clk%3Fsa%3DL%26ai%3DC8F7MNLIeYd6TIeH-1waw67-QAqfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLXc3ApPKCzPqgDAaoE8wFP0LY82OtFAB0Q9ycyhOfs29U6gCjsb_J7SeHm0-hwRBKUGpEqcq3EDi_ZKQGJNha5ZnIRyRd27IHZepbMsLQcj96h6LSz7oSqGJBRLh03QnZyr7gxOmnE1sA8qUqcU9ZEleU8gI9WxupfPrhhZy5n0oFlNHT3cLhZt0ZwZMJh40ZqQW9K9-vpplQ76t7gcmSF-Vyc3ZynAVir5yRruvQlrk7qWzvFZeEjvUs6DwqVz8IS_6knEal-oVeumhWDVl3OuZklHyPHJM8e7VEIGDo4veBcT8jHgNX7NSStvcCkLCUjca-ad47LkM1WA1zQAMDJnmXABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQH4FgGAFwE%26ae%3D1%26num%3D1%26cid%3DCAASEuRo48gjMc_SHcHWpS02b0onqQ%26sig%3DAOD64_0ti9XiodxK2Qz5_LrMPIKo7rkTyA%26client%3Dca-pub-9222145312954144%26dbm_c%3DAKAmf-DIdad9ixnPh3EniQJI2amaMYJfIONz4bplc_ENy7VdRvrGhnRDnmPiDiOEjC6AuR236D3bcZ5aScbhZXxbvMlar4QYlB0YC1EGZIHSbJLWoEZWtW5MjT3Up1ALeDxjlwW4hpTYKsuuxb-D1sCPeg1sHRo2Vw%26dbm_d%3DAKAmf-AqEyv27Y9NaJOhtN03LTnszOQ_dO-dp2rANTEjcvNzwjATBLVaavgh5fzBsTbPQbQIdr20VD9c5wWtj5nvLGk4mlrgoQhai7gsCzI5JZUBzMJ-fh_9blJwspNskECvUjO7ixwM6bzXow5XiPZM12ktQ-_dAf8WVA4QJl7ZwAZurb-W9jgqZUDv7s3Wl_kp_5zMuqMbh1N7t4HJBSRZfgDD_OVAm92Ql94cKqxGxNd8Cu6cJPydSzvMXgWzabXg3zWUMO40T02rXlPsjuTSHaDNW9uZzWH_v3jUS4Y-pwj7QHbVDN2uPB8OmxpMdV-SXBq7Ny3K7iYcQAankfShm-AvKUmCB5ZVwmWB1p4yg3Gsy805QDK8qokDSwj7iSDLlJL4u9RIJ4KWCPNQE9v54HBBaTnvOSNjoulOjebWBTtU5lckEXdjff8FW8ae1_qD3kipxx3QmywgO3654MVhVfqe1fyopw%26adurl%3D&r=1629401652543198") != -1){
                    cScrNode = scrNodes[i];
                }
            }
        }   
...
function jvxCopyObject(target,obj){
	...
	if(document.body == null){
		document.write("<div id='jvxSkeletonRef_611eb297e849e' style='display:none;'></div>")
	}
/*
JavaScript responsible for frame busting
*/
var jvx_611eb297e849eTraffickedInFrame = false,			// COM: should be true, if !busted and self != top
	jvx_611eb297e849eSafeFrameSupported = false,		// COM: should be true only when safeFrame is supported in the page
	jvx_611eb297e849eCanBustFromFrame = true,			// COM: should be false, when all busting method fails
	jvx_611eb297e849eInNestedFrame = false;				// COM: should be true, when tag trafficked inside nested frame

if(self != top){
	jvx_611eb297e849eTraffickedInFrame = true;
}

try{
		$sf.ext.register(300, 250);
		jvx_611eb297e849eSafeFrameSupported = true;
}catch(e){
	jvx_611eb297e849eSafeFrameSupported = false;
}
...
var adViewabilityDetectInit = function (visibilityThreshold) { 
    try {
        ...
        boxElement = document.querySelector('#adUnitContainer_611eb297e849e');
                    ...
                    if (!adInVPForOneSec && !timerRunning) {
                        ...
                        timeoutHandle = setTimeout(function () {
                            adInVPForOneSec = true;
                                                        if(typeof jvx_611eb297e849e != "undefined")
                            jvx_611eb297e849e.recordEvent(73);
                            else 
                            recordEvent(73);
                                                    }, 1000);
                    }
...
var CreativeUnit = (function(){
	...
	function receiveHtml5Message(e){
        ...
        var s = e.data.split(':', 10);
		        if(s && s.length >= 2 && s[0] == 'jvx_611eb297e849e'){
			var msg = s[1];
			if(msg == 'openExpansion'){
									jvx_611eb297e849e.openClickThrough();
							} else if(msg == 'closeExpansion'){
				jvx_611eb297e849e.closeExpansion(false, false);
			} else if(msg == 'expansionLoaded'){
							} else if(msg == 'recordUIR'){
				jvx_611eb297e849e.UIRRecorded = true;
			} else if(msg == 'lastMouseLeave'){
				jvx_611eb297e849e.lastMLeaveId = s[2];
			} else if(msg == 'clearUIR'){
				clearTimeout(jvx_611eb297e849e.UIRTimer);
			} else if(msg == 'recordDwell'){
				if(!jvx_611eb297e849e.DwellRecorded){
					jvx_611eb297e849e.recordDwellEvent(49, jvx_611eb297e849e.DwellElapsedTime);
				}
			}
									else if(msg=="dynamicProperties") {
                jvx_611eb297e849e.updateDYProperties(s[2],1);
							}
												                        else if(msg == "miniScrollerBgInfo"){
                var miniScrollerBgURL = decodeURIComponent(s[2]);
                jvx_611eb297e849e.fixedBgAstLeft = parseInt(s[3]);
                jvx_611eb297e849e.renderFixedPageBg(miniScrollerBgURL,s[3]);
            } 
		}
	}
	...
	function postHtml5Message(winRef, msg){
		try{
			winRef.postMessage('jvx_611eb297e849e' + ':' + msg, "*");
		}catch(e){
			if(typeof(winRef.contentWindow) != 'undefined')
				winRef.contentWindow.postMessage('jvx_611eb297e849e' + ':' + msg, "*");
		}
	}
	...
	*/
	...
	function clearNode(pNode, idPrefix){
        ...
        if(jvx_611eb297e849eTraffickedInFrame){
                        try{
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
			...
			if(url.indexOf("?") == -1){
				...
				finalURL = url + "&r=" + Math.random();
					...
					if(typeof jvx_611eb297e849e != 'undefined'){
				finalURL += "&es_cgName_"+jvx_611eb297e849e.DYReportingKey;
                if(jvx_611eb297e849e.DYSegmentName != ""){
                    finalURL += "&es_segName_"+jvx_611eb297e849e.DYSegmentName;
                }
			}
				imgEl.src = finalURL;
			}       
	...
	function setOpacity(myElement, opacityValue) {
		...
		var cLeft = sfLeft + "px",
			cTop = sfTop + "px",
			cNode = getElById(jvx_611eb297e849e.adUnitContainerId);
		addStyles(cNode, {"left":cLeft, "top":cTop});
	}
	function renderAdInsideSafeFrame(animDir){
		if(jvx_611eb297e849eSafeFrameSupported){
			/* ------------- SafeFrame Settings--------------- */
						var ref = jvx_611eb297e849e,
	 ...
	 /* var rect = obj.getBoundingClientRect();
		...
		var vpStyles = findPos(getElById(jvx_611eb297e849e.adUnitContainerId)),
			vpTop = "", vpLeft = "";
	...
	function mraidHandleOnViewable(viewable){
		jvxMraidIsShown = viewable;		 
			if(!jvxMraidIsShown || getElById(jvx_611eb297e849e.baseContainerId)){
				return; 
			}
		jvx_611eb297e849e.init();
	...
	function handleMraidViewableImprFiring(){
		if (!adInVPForOneSec && !timerRunning) {
			...
			var timeoutHandle = setTimeout(function () {
				adInVPForOneSec = true;
				jvx_611eb297e849e.recordEvent(74);
			}, 1000);
		}
	}
	...
	function CreativeUnit(uniqId){
	    ...
	    this.id = uniqId;  
		this.playerParamsMap = {"reportingURL":"https:\/\/evs.jivox.com","addPostCode":"https:\/\/cdn.jivox.com\/files\/46220\/Nike_DV\/dv_nike.js","creativeUnitType":"20","bDim":"300x250","bUnitId":"2000","siteId":"45f3d18e47f96c","campaignId":"145089","es_pId":"lP6W4c","isDynamic":"1","ap_DataSignal1":"42577385","ap_DataSignal2":"ABAjH0ibgypJGjbarXO0QYnWzfg1","ap_DataSignal3":"327227621","ap_DataSignal4":"851838508933","gdpr":"","gdpr_consent":"","jvxVer":"2","cMacro":"https:\/\/googleads.g.doubleclick.net\/dbm\/clk?sa=L&ai=C8F7MNLIeYd6TIeH-1waw67-QAqfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLXc3ApPKCzPqgDAaoE8wFP0LY82OtFAB0Q9ycyhOfs29U6gCjsb_J7SeHm0-hwRBKUGpEqcq3EDi_ZKQGJNha5ZnIRyRd27IHZepbMsLQcj96h6LSz7oSqGJBRLh03QnZyr7gxOmnE1sA8qUqcU9ZEleU8gI9WxupfPrhhZy5n0oFlNHT3cLhZt0ZwZMJh40ZqQW9K9-vpplQ76t7gcmSF-Vyc3ZynAVir5yRruvQlrk7qWzvFZeEjvUs6DwqVz8IS_6knEal-oVeumhWDVl3OuZklHyPHJM8e7VEIGDo4veBcT8jHgNX7NSStvcCkLCUjca-ad47LkM1WA1zQAMDJnmXABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQH4FgGAFwE&ae=1&num=1&cid=CAASEuRo48gjMc_SHcHWpS02b0onqQ&sig=AOD64_0ti9XiodxK2Qz5_LrMPIKo7rkTyA&client=ca-pub-9222145312954144&dbm_c=AKAmf-DIdad9ixnPh3EniQJI2amaMYJfIONz4bplc_ENy7VdRvrGhnRDnmPiDiOEjC6AuR236D3bcZ5aScbhZXxbvMlar4QYlB0YC1EGZIHSbJLWoEZWtW5MjT3Up1ALeDxjlwW4hpTYKsuuxb-D1sCPeg1sHRo2Vw&dbm_d=AKAmf-AqEyv27Y9NaJOhtN03LTnszOQ_dO-dp2rANTEjcvNzwjATBLVaavgh5fzBsTbPQbQIdr20VD9c5wWtj5nvLGk4mlrgoQhai7gsCzI5JZUBzMJ-fh_9blJwspNskECvUjO7ixwM6bzXow5XiPZM12ktQ-_dAf8WVA4QJl7ZwAZurb-W9jgqZUDv7s3Wl_kp_5zMuqMbh1N7t4HJBSRZfgDD_OVAm92Ql94cKqxGxNd8Cu6cJPydSzvMXgWzabXg3zWUMO40T02rXlPsjuTSHaDNW9uZzWH_v3jUS4Y-pwj7QHbVDN2uPB8OmxpMdV-SXBq7Ny3K7iYcQAankfShm-AvKUmCB5ZVwmWB1p4yg3Gsy805QDK8qokDSwj7iSDLlJL4u9RIJ4KWCPNQE9v54HBBaTnvOSNjoulOjebWBTtU5lckEXdjff8FW8ae1_qD3kipxx3QmywgO3654MVhVfqe1fyopw&adurl=","r":"1629401652543198","removeClickParams":"1","serverURL":"https:\/\/as.jivox.com"};
		...
		this.asyncCompletedTaskCount = 0;
			...
			this.asyncTaskCount++;
                        ...
                        this.apParamsArr = {"ap_DataSignal1":"42577385","ap_DataSignal2":"ABAjH0ibgypJGjbarXO0QYnWzfg1","ap_DataSignal3":"327227621","ap_DataSignal4":"851838508933"};
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=45f3d18e47f96c&campaignId=145089&es_pId=lP6W4c&isDynamic=1&ap_DataSignal1=42577385&ap_DataSignal2=ABAjH0ibgypJGjbarXO0QYnWzfg1&ap_DataSignal3=327227621&ap_DataSignal4=851838508933&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DC8F7MNLIeYd6TIeH-1waw67-QAqfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLXc3ApPKCzPqgDAaoE8wFP0LY82OtFAB0Q9ycyhOfs29U6gCjsb_J7SeHm0-hwRBKUGpEqcq3EDi_ZKQGJNha5ZnIRyRd27IHZepbMsLQcj96h6LSz7oSqGJBRLh03QnZyr7gxOmnE1sA8qUqcU9ZEleU8gI9WxupfPrhhZy5n0oFlNHT3cLhZt0ZwZMJh40ZqQW9K9-vpplQ76t7gcmSF-Vyc3ZynAVir5yRruvQlrk7qWzvFZeEjvUs6DwqVz8IS_6knEal-oVeumhWDVl3OuZklHyPHJM8e7VEIGDo4veBcT8jHgNX7NSStvcCkLCUjca-ad47LkM1WA1zQAMDJnmXABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQH4FgGAFwE%26ae%3D1%26num%3D1%26cid%3DCAASEuRo48gjMc_SHcHWpS02b0onqQ%26sig%3DAOD64_0ti9XiodxK2Qz5_LrMPIKo7rkTyA%26client%3Dca-pub-9222145312954144%26dbm_c%3DAKAmf-DIdad9ixnPh3EniQJI2amaMYJfIONz4bplc_ENy7VdRvrGhnRDnmPiDiOEjC6AuR236D3bcZ5aScbhZXxbvMlar4QYlB0YC1EGZIHSbJLWoEZWtW5MjT3Up1ALeDxjlwW4hpTYKsuuxb-D1sCPeg1sHRo2Vw%26dbm_d%3DAKAmf-AqEyv27Y9NaJOhtN03LTnszOQ_dO-dp2rANTEjcvNzwjATBLVaavgh5fzBsTbPQbQIdr20VD9c5wWtj5nvLGk4mlrgoQhai7gsCzI5JZUBzMJ-fh_9blJwspNskECvUjO7ixwM6bzXow5XiPZM12ktQ-_dAf8WVA4QJl7ZwAZurb-W9jgqZUDv7s3Wl_kp_5zMuqMbh1N7t4HJBSRZfgDD_OVAm92Ql94cKqxGxNd8Cu6cJPydSzvMXgWzabXg3zWUMO40T02rXlPsjuTSHaDNW9uZzWH_v3jUS4Y-pwj7QHbVDN2uPB8OmxpMdV-SXBq7Ny3K7iYcQAankfShm-AvKUmCB5ZVwmWB1p4yg3Gsy805QDK8qokDSwj7iSDLlJL4u9RIJ4KWCPNQE9v54HBBaTnvOSNjoulOjebWBTtU5lckEXdjff8FW8ae1_qD3kipxx3QmywgO3654MVhVfqe1fyopw%26adurl%3D&r=1629401652543198&objectName=jvx_611eb297e849e&adUnitId=2000&jvxSessionId=1629401751.4338';
        			this.baseURL += '&base=1';
	...
	CreativeUnit.prototype = {
		constructor:CreativeUnit,
         ...
         sendCookieRequest: function(cookieName){
	        if(jvx_611eb297e849eSafeFrameSupported){
		         var callBackFnName ='jvx_611eb297e849e'+".updateDYProperties";
		         jvx_611eb297e849e.addScriptTagToBody('https://as.jivox.com'+"/unit/getCookies.php?cookieName="+cookieName+"&callback="+callBackFnName+"&deleteCookie="+1+"&r_="+Math.random());  
	         }                  
         },
         updateDYProperties: function(val,isNotCookieData){
            ...
            jvx_611eb297e849e.DYReportingKey = dynPropArr[0] ? decodeURIComponent(dynPropArr[0]) : "";
            jvx_611eb297e849e.DYSegmentName = dynPropArr[1] ? decodeURIComponent(dynPropArr[1]) : "";
            //this.fireCREvent();
         },
			...
			if(doFireCreativeLoadEvt){
				...
				jvx_611eb297e849e.recordEvent(72, 'es_et=' + creativeLoadElapseTime);
			}
		},
                    ...
                    if(jvx_611eb297e849eSafeFrameSupported){
                        var getReportingKeyFromCookie = false,
                            ...
                            if(getReportingKeyFromCookie){
                                jvx_611eb297e849e.sendCookieRequest('jvx_611eb297e849e'+"_dynamicProperties");
                            }
                    }
                											}	
		},
			...
			var executeCallBack = function(transitionEvt){
					...
					if(ref.expansionOpen){
						...
						if(ref.openExpAgain) ref.openExpAgain = false; 
												...
												if(jvx_611eb297e849eSafeFrameSupported && transitionEvt){
							try{
								$sf.ext.collapse();
															}catch(e){}
						}
		...
		getIBusterFrameInfo:function(){
			if(typeof(jivoxIBusterAdObject) != "undefined"){
				...
				for(var i=0; i < iFramesLen; i++){
					if(hostIframes[i].contentWindow == jivoxIBusterAdObject["jvx_611eb297e849e"].foreignWindow){
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		openClickThrough:function(){
							this.openWindow('https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=C8F7MNLIeYd6TIeH-1waw67-QAqfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLXc3ApPKCzPqgDAaoE8wFP0LY82OtFAB0Q9ycyhOfs29U6gCjsb_J7SeHm0-hwRBKUGpEqcq3EDi_ZKQGJNha5ZnIRyRd27IHZepbMsLQcj96h6LSz7oSqGJBRLh03QnZyr7gxOmnE1sA8qUqcU9ZEleU8gI9WxupfPrhhZy5n0oFlNHT3cLhZt0ZwZMJh40ZqQW9K9-vpplQ76t7gcmSF-Vyc3ZynAVir5yRruvQlrk7qWzvFZeEjvUs6DwqVz8IS_6knEal-oVeumhWDVl3OuZklHyPHJM8e7VEIGDo4veBcT8jHgNX7NSStvcCkLCUjca-ad47LkM1WA1zQAMDJnmXABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQH4FgGAFwE&ae=1&num=1&cid=CAASEuRo48gjMc_SHcHWpS02b0onqQ&sig=AOD64_0ti9XiodxK2Qz5_LrMPIKo7rkTyA&client=ca-pub-9222145312954144&dbm_c=AKAmf-DIdad9ixnPh3EniQJI2amaMYJfIONz4bplc_ENy7VdRvrGhnRDnmPiDiOEjC6AuR236D3bcZ5aScbhZXxbvMlar4QYlB0YC1EGZIHSbJLWoEZWtW5MjT3Up1ALeDxjlwW4hpTYKsuuxb-D1sCPeg1sHRo2Vw&dbm_d=AKAmf-AqEyv27Y9NaJOhtN03LTnszOQ_dO-dp2rANTEjcvNzwjATBLVaavgh5fzBsTbPQbQIdr20VD9c5wWtj5nvLGk4mlrgoQhai7gsCzI5JZUBzMJ-fh_9blJwspNskECvUjO7ixwM6bzXow5XiPZM12ktQ-_dAf8WVA4QJl7ZwAZurb-W9jgqZUDv7s3Wl_kp_5zMuqMbh1N7t4HJBSRZfgDD_OVAm92Ql94cKqxGxNd8Cu6cJPydSzvMXgWzabXg3zWUMO40T02rXlPsjuTSHaDNW9uZzWH_v3jUS4Y-pwj7QHbVDN2uPB8OmxpMdV-SXBq7Ny3K7iYcQAankfShm-AvKUmCB5ZVwmWB1p4yg3Gsy805QDK8qokDSwj7iSDLlJL4u9RIJ4KWCPNQE9v54HBBaTnvOSNjoulOjebWBTtU5lckEXdjff8FW8ae1_qD3kipxx3QmywgO3654MVhVfqe1fyopw&adurl=http%3A%2F%2Fwww.nike.com');
				...
				openExpansion:function(autoExpand, skipOpenEvent){
						...
						if(!jvx_611eb297e849eCanBustFromFrame || jvx_611eb297e849eInNestedFrame){
				return;
			}
		...
		recordEvent:function(eventId,addnlParams){
				...
				var imgEl = document.createElement("img");
                var tempURL = "";
                var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + "145089/45f3d18e47f96c/20/jvxSId_1629401751.4338";
				...
				//eventReportingURL = (eventId == 1) ? (eventReportingURL + ";https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=C8F7MNLIeYd6TIeH-1waw67-QAqfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLXc3ApPKCzPqgDAaoE8wFP0LY82OtFAB0Q9ycyhOfs29U6gCjsb_J7SeHm0-hwRBKUGpEqcq3EDi_ZKQGJNha5ZnIRyRd27IHZepbMsLQcj96h6LSz7oSqGJBRLh03QnZyr7gxOmnE1sA8qUqcU9ZEleU8gI9WxupfPrhhZy5n0oFlNHT3cLhZt0ZwZMJh40ZqQW9K9-vpplQ76t7gcmSF-Vyc3ZynAVir5yRruvQlrk7qWzvFZeEjvUs6DwqVz8IS_6knEal-oVeumhWDVl3OuZklHyPHJM8e7VEIGDo4veBcT8jHgNX7NSStvcCkLCUjca-ad47LkM1WA1zQAMDJnmXABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQH4FgGAFwE&ae=1&num=1&cid=CAASEuRo48gjMc_SHcHWpS02b0onqQ&sig=AOD64_0ti9XiodxK2Qz5_LrMPIKo7rkTyA&client=ca-pub-9222145312954144&dbm_c=AKAmf-DIdad9ixnPh3EniQJI2amaMYJfIONz4bplc_ENy7VdRvrGhnRDnmPiDiOEjC6AuR236D3bcZ5aScbhZXxbvMlar4QYlB0YC1EGZIHSbJLWoEZWtW5MjT3Up1ALeDxjlwW4hpTYKsuuxb-D1sCPeg1sHRo2Vw&dbm_d=AKAmf-AqEyv27Y9NaJOhtN03LTnszOQ_dO-dp2rANTEjcvNzwjATBLVaavgh5fzBsTbPQbQIdr20VD9c5wWtj5nvLGk4mlrgoQhai7gsCzI5JZUBzMJ-fh_9blJwspNskECvUjO7ixwM6bzXow5XiPZM12ktQ-_dAf8WVA4QJl7ZwAZurb-W9jgqZUDv7s3Wl_kp_5zMuqMbh1N7t4HJBSRZfgDD_OVAm92Ql94cKqxGxNd8Cu6cJPydSzvMXgWzabXg3zWUMO40T02rXlPsjuTSHaDNW9uZzWH_v3jUS4Y-pwj7QHbVDN2uPB8OmxpMdV-SXBq7Ny3K7iYcQAankfShm-AvKUmCB5ZVwmWB1p4yg3Gsy805QDK8qokDSwj7iSDLlJL4u9RIJ4KWCPNQE9v54HBBaTnvOSNjoulOjebWBTtU5lckEXdjff8FW8ae1_qD3kipxx3QmywgO3654MVhVfqe1fyopw&adurl=http%3A%2F%2Fwww.nike.com") : eventReportingURL;
									tempURL += "/es_cgName="+jvx_611eb297e849e.DYReportingKey;
                    if(jvx_611eb297e849e.DYSegmentName != ""){
                        tempURL += "/es_segName="+jvx_611eb297e849e.DYSegmentName;
                    }
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			this.DwellTimer = null;
						...
						var cNode = createDivNode(this.adUnitContainerId);
			            												document.write('<div id="jvxScrRefNode_611eb297e849e" style="display:none;"></div>');	
				var jvxPNode = '';
				var jvxNode = getElById("jvxScrRefNode_611eb297e849e");
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=45f3d18e47f96c&campaignId=145089&es_pId=lP6W4c&isDynamic=1&ap_DataSignal1=42577385&ap_DataSignal2=ABAjH0ibgypJGjbarXO0QYnWzfg1&ap_DataSignal3=327227621&ap_DataSignal4=851838508933&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DC8F7MNLIeYd6TIeH-1waw67-QAqfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLXc3ApPKCzPqgDAaoE8wFP0LY82OtFAB0Q9ycyhOfs29U6gCjsb_J7SeHm0-hwRBKUGpEqcq3EDi_ZKQGJNha5ZnIRyRd27IHZepbMsLQcj96h6LSz7oSqGJBRLh03QnZyr7gxOmnE1sA8qUqcU9ZEleU8gI9WxupfPrhhZy5n0oFlNHT3cLhZt0ZwZMJh40ZqQW9K9-vpplQ76t7gcmSF-Vyc3ZynAVir5yRruvQlrk7qWzvFZeEjvUs6DwqVz8IS_6knEal-oVeumhWDVl3OuZklHyPHJM8e7VEIGDo4veBcT8jHgNX7NSStvcCkLCUjca-ad47LkM1WA1zQAMDJnmXABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQH4FgGAFwE%26ae%3D1%26num%3D1%26cid%3DCAASEuRo48gjMc_SHcHWpS02b0onqQ%26sig%3DAOD64_0ti9XiodxK2Qz5_LrMPIKo7rkTyA%26client%3Dca-pub-9222145312954144%26dbm_c%3DAKAmf-DIdad9ixnPh3EniQJI2amaMYJfIONz4bplc_ENy7VdRvrGhnRDnmPiDiOEjC6AuR236D3bcZ5aScbhZXxbvMlar4QYlB0YC1EGZIHSbJLWoEZWtW5MjT3Up1ALeDxjlwW4hpTYKsuuxb-D1sCPeg1sHRo2Vw%26dbm_d%3DAKAmf-AqEyv27Y9NaJOhtN03LTnszOQ_dO-dp2rANTEjcvNzwjATBLVaavgh5fzBsTbPQbQIdr20VD9c5wWtj5nvLGk4mlrgoQhai7gsCzI5JZUBzMJ-fh_9blJwspNskECvUjO7ixwM6bzXow5XiPZM12ktQ-_dAf8WVA4QJl7ZwAZurb-W9jgqZUDv7s3Wl_kp_5zMuqMbh1N7t4HJBSRZfgDD_OVAm92Ql94cKqxGxNd8Cu6cJPydSzvMXgWzabXg3zWUMO40T02rXlPsjuTSHaDNW9uZzWH_v3jUS4Y-pwj7QHbVDN2uPB8OmxpMdV-SXBq7Ny3K7iYcQAankfShm-AvKUmCB5ZVwmWB1p4yg3Gsy805QDK8qokDSwj7iSDLlJL4u9RIJ4KWCPNQE9v54HBBaTnvOSNjoulOjebWBTtU5lckEXdjff8FW8ae1_qD3kipxx3QmywgO3654MVhVfqe1fyopw%26adurl%3D&r=1629401652543198&objectName=jvx_611eb297e849e';
											this.baseURL += '&jvxSessionId=1629401751.4338';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&&siteId=45f3d18e47f96c&campaignId=145089&es_pId=lP6W4c&isDynamic=1&ap_DataSignal1=42577385&ap_DataSignal2=ABAjH0ibgypJGjbarXO0QYnWzfg1&ap_DataSignal3=327227621&ap_DataSignal4=851838508933&gdpr=&gdpr_consent=&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DC8F7MNLIeYd6TIeH-1waw67-QAqfeosRfm4zi35QN7OWEorgcEAEgiszaemD7oe6C9AmgAe_TgJMCyAEJqQLXc3ApPKCzPqgDAaoE8wFP0LY82OtFAB0Q9ycyhOfs29U6gCjsb_J7SeHm0-hwRBKUGpEqcq3EDi_ZKQGJNha5ZnIRyRd27IHZepbMsLQcj96h6LSz7oSqGJBRLh03QnZyr7gxOmnE1sA8qUqcU9ZEleU8gI9WxupfPrhhZy5n0oFlNHT3cLhZt0ZwZMJh40ZqQW9K9-vpplQ76t7gcmSF-Vyc3ZynAVir5yRruvQlrk7qWzvFZeEjvUs6DwqVz8IS_6knEal-oVeumhWDVl3OuZklHyPHJM8e7VEIGDo4veBcT8jHgNX7NSStvcCkLCUjca-ad47LkM1WA1zQAMDJnmXABNHhsb6oA-AEA5AGAaAGTYAH-av_7AGoB9XJG6gH8NkbqAfy2RuoB47OG6gHk9gbqAe6BqgH7NUbqAfulrECqAemvhuoB-zVG6gH89EbqAeW2BuoB6qbsQLYBwDSCAkIgOGAEBABGB-ACgGYCwHICwGADAGwE-CSpwzQEwDYEw3YFAHQFQH4FgGAFwE%26ae%3D1%26num%3D1%26cid%3DCAASEuRo48gjMc_SHcHWpS02b0onqQ%26sig%3DAOD64_0ti9XiodxK2Qz5_LrMPIKo7rkTyA%26client%3Dca-pub-9222145312954144%26dbm_c%3DAKAmf-DIdad9ixnPh3EniQJI2amaMYJfIONz4bplc_ENy7VdRvrGhnRDnmPiDiOEjC6AuR236D3bcZ5aScbhZXxbvMlar4QYlB0YC1EGZIHSbJLWoEZWtW5MjT3Up1ALeDxjlwW4hpTYKsuuxb-D1sCPeg1sHRo2Vw%26dbm_d%3DAKAmf-AqEyv27Y9NaJOhtN03LTnszOQ_dO-dp2rANTEjcvNzwjATBLVaavgh5fzBsTbPQbQIdr20VD9c5wWtj5nvLGk4mlrgoQhai7gsCzI5JZUBzMJ-fh_9blJwspNskECvUjO7ixwM6bzXow5XiPZM12ktQ-_dAf8WVA4QJl7ZwAZurb-W9jgqZUDv7s3Wl_kp_5zMuqMbh1N7t4HJBSRZfgDD_OVAm92Ql94cKqxGxNd8Cu6cJPydSzvMXgWzabXg3zWUMO40T02rXlPsjuTSHaDNW9uZzWH_v3jUS4Y-pwj7QHbVDN2uPB8OmxpMdV-SXBq7Ny3K7iYcQAankfShm-AvKUmCB5ZVwmWB1p4yg3Gsy805QDK8qokDSwj7iSDLlJL4u9RIJ4KWCPNQE9v54HBBaTnvOSNjoulOjebWBTtU5lckEXdjff8FW8ae1_qD3kipxx3QmywgO3654MVhVfqe1fyopw%26adurl%3D&r=1629401652543198&objectName=jvx_611eb297e849e'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1629401751.4338';
		...
		listenerCallback:function(event) {
			jvx_611eb297e849e.eventController(event); 
		},
...
var jvx_611eb297e849e = new CreativeUnit("_611eb297e849e");
jvx_611eb297e849e.DYReportingKey = "";
jvx_611eb297e849e.DYSegmentName = "";
	if(NonMraidTagInMraidEnv){
				jvx_611eb297e849e.recordEvent(75);
	}
    jvx_611eb297e849e.init();
